...
declare function extractCliInputParamsDetailed(schema: Schema): ParamInfo[];
declare function extractOutputParamsDetailed(schema: Schema): ParamInfo[];
export declare function getInputTypeHint(schema: Schema): string;
export { extractCliInputParamsDetailed, extractOutputParamsDetailed, type ParamInfo, };

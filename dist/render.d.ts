...
type FrameworkErrorCode = 'INVALID_INPUT' | 'INVALID_CONTEXT' | 'UNKNOWN_COMMAND' | 'NOT_A_COMMAND' | 'BAD_PATH' | 'BAD_SELECTOR' | 'BAD_INPUT_JSON' | 'TWO_INPUTS' | 'RUN_DISABLED' | 'NO_SKILL' | 'UNKNOWN_SKILL_FILE' | 'RUNTIME_ERROR';
